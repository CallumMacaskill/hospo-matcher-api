...
@router.post(path="/")
async def create_session(session: Session, db: Database=Depends(driver.get_db_client)):
    """
...
async def read_session(code: str, db: Database=Depends(driver.get_db_client)) -> Session:
    """
